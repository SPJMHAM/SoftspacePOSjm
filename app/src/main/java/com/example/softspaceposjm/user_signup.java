    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(user_signup.this, login_page1.class);
...
//                    mDialog.dismiss();
                    ...
                    Toast.makeText(user_signup.this, "User Name should be between 8 to 15", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (edtICno.length() < 12 || edtICno.length() > 12) {
//                    mDialog.dismiss();
                    Toast.makeText(user_signup.this, "IC not valid", Toast.LENGTH_SHORT).show();
                    return;
                }

                if(edtAddress==null){
                    //             mDialog.dismiss();
                    Toast.makeText(user_signup.this, "Please enter email address", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(edtPassword==null){
                    //             mDialog.dismiss();
                ...
                if(edtPassword.length() < 8 || edtPassword.length() > 20){
                    //             mDialog.dismiss();
                    Toast.makeText(user_signup.this, "Password should be between 8 to 20", Toast.LENGTH_SHORT).show();
                ...
                if(!matchPassword.equals(matchPassword1)){
                    //             mDialog.dismiss();
                    Toast.makeText(user_signup.this, "Password not match", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                table_user.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.child(edtUserName.getText().toString()).exists()) {
                            ...
                            Toast.makeText(user_signup.this, "Name already register", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        // EditText edtUserName,edtICno,edtAddress,edtPassword,edtConfirmPassword,edtEmail;
                        Intent intent = new Intent(user_signup.this, login_page1.class);
